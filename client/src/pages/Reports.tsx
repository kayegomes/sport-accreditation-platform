...
export default function Reports() {
  ...
  const exportAccreditationsBySupplier = trpc.exports.exportAccreditationsBySupplier.useMutation({
    onSuccess: (data: any) => {
      toast.success("Relatório gerado com sucesso!");
      window.open(data.url, "_blank");
    },
  ...
  const handleGenerateReport = () => {
    if (reportType === "collaborators_by_event") {
      ...
      exportAccreditationsByStatus.mutate({
        eventId: selectedEventId && selectedEventId !== "ALL_EVENTS" ? parseInt(selectedEventId) : undefined,
      });
    } else if (reportType === "accreditations_by_supplier") {
      exportAccreditationsBySupplier.mutate({
        eventId: selectedEventId && selectedEventId !== "ALL_EVENTS" ? parseInt(selectedEventId) : undefined,
      });
  ...
  const isGenerating = 
    ...
    exportAccreditationsBySupplier.isPending ||
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Select value={reportType} onValueChange={setReportType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="accreditations_by_supplier">
                      Credenciamento por Fornecedor (Pendente x Preenchido)
                    </SelectItem>
              ...
              {(reportType === "accreditations_by_status" || reportType === "accreditations_by_supplier") && (
                <div className="grid gap-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <h3 className="font-semibold">Credenciamento por Fornecedor</h3>
              <p className="text-sm text-muted-foreground">
                Mostra o status de credenciamento (pendente vs já preenchido) por fornecedor.
                Pode ser filtrado por evento específico.
              </p>
            </div>
            <div>
